        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Nama :</strong>
                    <input type="text" name="nama" value="{{ $kls->nama }}" class="form-control"
                        placeholder="Nama">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="deskripsi" value="{{ $kls->deskripsi }}" class="form-control"
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="id_guru" value="{{ $kls->id_guru }}" class="form-control"
                        placeholder="Id Guru">
                </div>
            </div>
