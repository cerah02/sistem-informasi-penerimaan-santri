...
<div class="container mt-5">
    ...
    <form action="{{ route('ortus.store') }}" method="POST" class="shadow p-4 bg-light rounded">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="pendidikan_ayah" class="form-control" id="pendidikan_ayah" placeholder="Masukan Pendidikan Terakhir Ayah">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="pendidikan_ibu" class="form-control" id="pendidikan_ibu" placeholder="Masukan Pendidikan Terakhir Ibu">
        </div>
        <div class="mb-3">
