    ...
    <div class="container mt-5">
        <div class="card shadow-lg">
            <div class="card-body">
                ...
                <form id="multiStepForm" action="{{ route('santris.tambah') }}" method="POST">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="tempat_tinggal" value="Orang Tua"
                                required>
                            <label class="form-check-label">Orang Tua</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="tempat_tinggal" value="Kakek/Nenek"
                                required>
                            <label class="form-check-label">Kakek/Nenek</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="tempat_tinggal" value="Paman/Bibi"
                                required>
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="tempat_tinggal" value="Kerabat"
                                required>
                            <label class="form-check-label">Kerabat</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="tempat_tinggal" value="Panti/Ponten"
                                required>
                            <label class="form-check-label">Panti/Ponten</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="tempat_tinggal" value="Lainnya"
                                required>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="status_dkluarga" value="Anak Kandung"
                                required>
                            <label class="form-check-label">Anak Kandung</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="status_dkluarga"
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="status_dkluarga" value="Anak Angkat"
                                required>
